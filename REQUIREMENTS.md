...
> **Companion to `plan.md`.** This document defines *what* the system must do and the
> qualities it must have. `plan.md` defines *how* it is built. Every requirement here
