...
## Corpus Check
- 105 files · ~67,944 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1148 nodes · 2189 edges · 79 communities (59 shown, 20 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 23 edges (avg confidence: 0.82)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b8797e3b`
...
5. `formatNpr()` - 14 edges
6. `Card()` - 12 edges
7. `CardTitle()` - 12 edges
8. `Input()` - 12 edges
9. `authClient` - 12 edges
10. `3. Detailed Audit Findings & Applied Remediations` - 12 edges
...
Cohesion: 0.06
Nodes (95): InvoiceDetailsPage(), cn(), getLeases, getProperties, getRooms, getTenants, Alert(), AlertAction() (+87 more)
...
Cohesion: 0.06
Nodes (43): addonLabel, alertHtml, btn, { container }, { container, rerender }, css, dialogHtml, digits (+35 more)
...
Cohesion: 0.14
Nodes (21): css, element, id, props, MenuCheckboxItem(), MenuGroup(), MenuGroupLabel(), MenuItem() (+13 more)
...
Cohesion: 0.12
Nodes (15): d1000, dangerousAmounts, formatted, items, mockDb, MockDbState, months, nextDay (+7 more)

### Community 24 - "Community 24"
Cohesion: 0.22
Nodes (8): authClient, Drawer(), DrawerDescription(), DrawerHeader(), DrawerPanel(), DrawerPopup(), DrawerTitle(), DrawerTrigger()

### Community 25 - "Community 25"
Cohesion: 0.24
Nodes (12): invoices, payments, addDaysInKathmandu(), getCurrentDateTimeInKathmandu(), getTodayInKathmandu(), isPastDateInKathmandu(), CreateManualInvoiceInput, recalculateInvoiceStatus() (+4 more)
...
Cohesion: 0.17
Nodes (9): Database, recordCashPayment(), landlordAuthMiddleware, recordCashPaymentSchema, recordCashPaymentFn, insertedPayment, InvoiceRecord, mockDb (+1 more)
...
Cohesion: 0.39
Nodes (6): DashboardPage(), formatNpr(), nprToPaisa(), paisaToNpr(), formatted, testCases
...
Cohesion: 0.29
Nodes (7): InputGroupAddon(), inputGroupAddonVariants, InputGroupInput(), InputGroupText(), InputGroupTextarea(), InputProps, TextareaProps

### Community 35 - "Community 35"
Cohesion: 0.36
Nodes (5): tenants, createTenantSchema, updateTenantSchema, createTenant, updateTenant
...
- **Why does `cn()` connect `Community 0` to `Community 2`, `Community 34`, `Community 7`, `Community 48`, `Community 17`, `Community 18`, `Community 21`, `Community 24`, `Community 30`?**
  _High betweenness centrality (0.081) - this node is a cross-community bridge._
- **Why does `formatNpr()` connect `Community 32` to `Community 0`, `Community 4`, `Community 5`, `Community 12`, `Community 23`, `Community 25`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `Todos DB Schema` connect `Community 16` to `Community 49`?**
