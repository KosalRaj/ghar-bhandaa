...
export function TableHeader({
  ...
  return (
    <thead
      className={cn('[&_tr]:border-b border-[var(--line)]', className)}
...
export function TableRow({
  ...
  return (
    <tr
      className={cn(
        'relative border-b border-[var(--line)] not-in-data-[variant=card]:hover:bg-muted/40 not-in-data-[variant=card]:data-[state=selected]:bg-muted dark:not-in-data-[variant=card]:hover:bg-muted/30 transition-colors',
        className,
      )}
      data-slot="table-row"
      {...props}
...
export function TableHead({
  ...
  return (
    <th
      className={cn(
        'h-10 whitespace-nowrap px-3 text-left align-middle font-semibold text-xs uppercase tracking-wider text-[var(--sea-ink-soft)] leading-none has-[[role=checkbox]]:w-px last:has-[[role=checkbox]]:ps-0 first:has-[[role=checkbox]]:pe-0',
        className,
      )}
...
export function TableCell({
  ...
  return (
    <td
      className={cn(
        'whitespace-nowrap bg-clip-padding px-3 py-3 align-middle text-sm text-[var(--sea-ink)] leading-none in-data-[slot=table-footer]:py-3.5 in-data-[variant=card]:first:ps-[calc(--spacing(2.5)-1px)] in-data-[variant=card]:last:pe-[calc(--spacing(2.5)-1px)] has-[[role=checkbox]]:w-px last:has-[[role=checkbox]]:ps-0 first:has-[[role=checkbox]]:pe-0',
        className,
      )}
