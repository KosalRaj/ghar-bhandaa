...
export function Empty({
  ...
  return (
    <div
      className={cn(
        'flex min-w-0 flex-1 flex-col items-center justify-center gap-4 text-balance px-6 py-12 text-center md:py-16',
        className,
      )}
      data-slot="empty"
      {...props}
...
export function EmptyDescription({
  ...
  return (
    <div
      className={cn(
        'text-muted-foreground text-sm [&>a:hover]:text-primary [&>a]:underline [&>a]:underline-offset-4 [[data-slot=empty-title]+&]:mt-1 max-w-xs',
        className,
      )}
